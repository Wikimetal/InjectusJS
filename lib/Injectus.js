...
{
  if(!value || !value.Interface || !value.Interface.Name() || !value.Implementation.Name())
    throw "Invalid component to register. Reason: null component or Interface property not initialized";
  var interfaceName=value.Interface.Name() ;
...
Injectus.Resolve=function(value)
{
  ...
  var implementationName=injectus.Components[valueName].Implementation.Name();
